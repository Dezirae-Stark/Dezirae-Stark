...
**Release:** [v3.14.0-beta.4 — latest Windows installer (EyeSpy finder + curated 3×3 wall; carries the whole 3.14.0-beta line)](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.14.0-beta.4) · [v3.6.8 — last fully-stable build](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.6.8)
