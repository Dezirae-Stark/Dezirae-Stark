...
**Release:** [v3.13.0-beta.1 — latest Windows installer (experimental beta: clickable search + chess AI + Space-Cadet pinball + offline AI memory)](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.13.0-beta.1) · [v3.6.8 — last fully-stable build](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.6.8)
