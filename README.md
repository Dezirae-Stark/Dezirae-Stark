...
**Release:** [v3.13.2-beta.1 — latest Windows installer (reconnect hardening verified + chat leaves EXPERIMENTAL + Win98 boot splash + new blue default wallpaper)](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.13.2-beta.1) · [v3.6.8 — last fully-stable build](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.6.8)
