...
**Release:** [v3.14.0-beta.5 — latest Windows installer (GeoINT map fix; EyeSpy finder + curated 3×3 wall; the whole 3.14.0-beta line)](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.14.0-beta.5) · [v3.6.8 — last fully-stable build](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.6.8)
