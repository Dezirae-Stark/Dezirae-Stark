...
**Release:** [v3.14.0-beta.7 — latest Windows installer (GeoINT crash-recovery + Purge; Mail Send fix; Bookmarks auto-fit; EyeSpy webpage kind; Cases categories; the whole 3.14.0-beta line)](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.14.0-beta.7) · [v3.6.8 — last fully-stable build](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.6.8)
