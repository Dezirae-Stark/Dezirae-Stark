...
**Chat (beta, experimental):** an opt-in, Tor-only **P2P chat** — invite-link 1:1 with a PQ-hybrid X25519+ML-KEM-768 handshake (no hosting, loopback-only sockets), plus **file attachments** (hash-verified, encrypted-at-rest quarantine, explicit save), **small groups** (client-side fan-out — zero new cryptography), and **case-aware sharing** (share an entity or attachment straight into a chat). The handshake crypto is **EXPERIMENTAL and not yet formally verified** — labeled as such in-app and shipped only as a pre-release.
...
**Release:** [v3.13.1-beta.1 — latest Windows installer (experimental beta: pinball playability fix + CryptoVerif hybrid proof; clickable search, chess AI, offline AI memory)](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.13.1-beta.1) · [v3.6.8 — last fully-stable build](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.6.8)
