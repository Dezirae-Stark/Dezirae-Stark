...
- **DialTerm** (SSH/Telnet/FTP, dial-up handshake), **Net Explorer**, **Mail** (IMAP/SMTP), and a pluggable local-AI assistant with a one-click Ollama setup wizard
...
**Security:** offline-first, no telemetry, consent-gated egress. Encrypt-at-rest reviewed across three adversarial rounds; the 3.2.x module surface went through a dedicated red-team pass (0 Critical, all findings fixed in v3.2.3).

**Release:** [v3.2.3 — Windows installer + full source](https://github.com/Dezirae-Stark/ghost-access-98/releases/tag/v3.2.3)
