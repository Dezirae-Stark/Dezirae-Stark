...
| **OSINT tooling** | Ghost Intel 98 (offline case-management desktop) + GhostExodus counter-extremism suite | 1,182 tests / v1.1.0 |
...
<details>
<summary><b>Deep dive — Recon Bridge: full cross-project HMAC review log (Codex R1–R4)</b></summary>
...
<details>
<summary><b>Complete version history — v3.2.x → v3.16.2 (formerly Ghost Access 98 / Dead Cyber Society 98)</b></summary>
