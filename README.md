...
**Release:** [v3.16.0 — latest Windows installer](https://github.com/Obsidian-Circuit-LLC/ghost-intel-98/releases/tag/v3.16.0) (Live News pop-out, manual CCTV coordinates + master-JSON export, formatted AI replies; CCTV map layer from v3.15.0). 1167 automated tests.
