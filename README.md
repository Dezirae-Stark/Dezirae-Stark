...
**Release:** [v3.14.0-beta.3 — latest Windows installer (EyeSpy location grid; carries the beta.1 punch-list + the beta.2 boot fix)](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.14.0-beta.3) · [v3.6.8 — last fully-stable build](https://github.com/Obsidian-Circuit-LLC/dcs98/releases/tag/v3.6.8)
