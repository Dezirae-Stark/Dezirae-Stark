...
**Release:** [v3.16.1 — latest Windows installer](https://github.com/Obsidian-Circuit-LLC/ghost-intel-98/releases/tag/v3.16.1) (user-supplied Piper voices; Live News pop-out, manual CCTV coordinates + master-JSON export, formatted AI replies from v3.16.0). 1177 automated tests.
